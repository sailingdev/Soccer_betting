...
def main():
	...
	doing_scraping_match_plan("2021-2022", "cro-1-hnl", firstMatch = 116, lastMatch = 140) #2/27
	doing_scraping_match_plan("2021-2022", "hun-nb-i", firstMatch = 120, lastMatch = 150) #2/27
