...
def main():
	...
	doing_scraping_match_plan("2021-2022", "cro-1-hnl", firstMatch = 1, lastMatch = 155) # 4/17
	doing_scraping_match_plan("2021-2022", "hun-nb-i", firstMatch = 1, lastMatch = 168)  # 4/17
