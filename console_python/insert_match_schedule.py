...
def main(): 
	# doing_scraping_match_plan("2021-2022", "aut-bundesliga", firstMatch = 127)
	# doing_scraping_match_plan("2021-2022", "bul-parva-liga", firstMatch = 148)
	# doing_scraping_match_plan("2021-2022", "cze-1-fotbalova-liga", firstMatch = 185)
	# doing_scraping_match_plan("2021-2022", "den-superligaen", firstMatch = 115)
	# doing_scraping_match_plan("2021-2022", "eng-premier-league")
	# doing_scraping_match_plan("2021-2022", "fra-ligue-1", firstMatch = 261)
	# doing_scraping_match_plan("2021-2022", "bundesliga", firstMatch = 217)
	# doing_scraping_match_plan("2021-2022", "gre-super-league", firstMatch = 170)
	# doing_scraping_match_plan("2021-2022", "ita-serie-a", firstMatch = 271)
	# doing_scraping_match_plan("2021-2022", "ned-eredivisie", firstMatch = 217)
	# doing_scraping_match_plan("2021-2022", "por-primeira-liga", firstMatch = 217)
	# doing_scraping_match_plan("2021-2022", "srb-super-liga", firstMatch = 201)
	# doing_scraping_match_plan("2021-2022", "esp-primera-division", firstMatch = 261)
	# doing_scraping_match_plan("2021-2022", "sui-super-league", firstMatch = 121)
	# doing_scraping_match_plan("2021-2022", "tur-sueperlig", firstMatch = 271)
	...
	doing_scraping_match_plan("2021-2022", "hun-nb-i", firstMatch = 1, lastMatch = 150) #3/20 + 6
