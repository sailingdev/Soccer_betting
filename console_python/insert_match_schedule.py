...
def main():
	...
	doing_scraping_match_plan("2021-2022", "cro-1-hnl", firstMatch = 1, lastMatch = 170) # 5/8
	doing_scraping_match_plan("2021-2022", "hun-nb-i", firstMatch = 1, lastMatch = 186)  # 5/8
